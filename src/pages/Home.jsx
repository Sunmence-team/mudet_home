...
const Home = () => {
  ...
  const faqs = [
    {
      ...
      answer:
        "Our products are made from 100% natural ingredients, carefully sourced and backed by both traditional herbal knowledge and modern science. We avoid artificial additives or preservatives, ensuring pure, safe, and effective wellness solutions.",
    },
    {
      question: "What payment methods are accepted?",
      answer:
        "We accept various payment methods including credit/debit cards, bank transfers, and mobile payments. You can select your preferred method during checkout.",
    },
    {
      question: "How can I reset my password?",
      answer:
        'To reset your password, go to the login page and click "Forgot Password." Enter your email address, and we’ll send you a link to reset your password.',
    },
    {
      question: "Is there a refund policy?",
      answer:
        "Yes, we offer a 30-day refund policy for eligible purchases. Please review our refund policy page for detailed terms and conditions.",
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        "Pure, handpicked natural ingredients from trusted farms for maximum goodness without compromise.",
      bgColor: "bg-pryClr",
      icon: (
        <CgLivePhoto className="text-white text-4xl md:text-5xl lg:text-6xl" />
      ),
    },
    {
      title: "No Artificial Additives or Preservatives",
      description:
        "Free from harmful chemicals, additives, and preservatives, just what your body truly needs.",
      bgColor: "bg-secClr",
      icon: (
        <RiSparkling2Line className="text-white text-4xl md:text-5xl lg:text-6xl" />
      ),
    },
    {
      title: "Herbal Science & Tradition",
      description:
        "Blending ancient herbal wisdom with modern research for safe, effective results",
      bgColor: "bg-secClr",
      icon: (
        <MdHealthAndSafety className="text-white text-4xl md:text-5xl lg:text-6xl" />
      ),
    },
    {
      title: "Customer Support That Cares",
      description:
        "Guidance and assistance to help you achieve your health goals with confidence.",
      bgColor: "bg-pryClr",
      icon: (
        <BiSupport className="text-white text-4xl md:text-5xl lg:text-6xl" />
      ),
    },
  ];
  ...
  const steps = [
    ...
    },
    {
      ...
      title: "Invite People",
      description:
        "Once your account is set up, invite friends,family and others to join ",
      icon: IoPersonAdd,
    ...
    },
    {
      ...
      description:
        "By joining our referral program, you can earn commissions for every successful referral",
      icon: FaMoneyBill1,
      iconColor: "text-secClr",
      iconBgColor: "bg-secClr/30",
    },
  ...
  const fallbackTestimonials = [
    {
      ...
      testimonial:
        "I feel Healthier and More Energized! Since I started using their herbal supplements, my energy level has improved, and I feel more alive everyday",
    },
    {
      ...
      title: "Fitness Coach",
      testimonial:
        "These products have transformed my daily routine,I’ve noticed a significant boost in my stamina and overall wellness since incorporating them.",
    },
    {
      ...
      testimonial:
        "The natural ingredients in these supplements make all the difference, I feel rejuvenated and my skin has never locked better!",
    },
    {
      ...
      title: "Nutritionist",
      testimonial:
        "As a professional, I recommend these herbal supplements to my clients. They’ve helped me maintain my energy and focus throughout the day.",
    },
  ];

  const finalTestimonials =
    loadingTestimonials || !testimonials || testimonials.length < 2
    ...
    <div className="w-full flex flex-col">
            ...
            <div className="w-[90%] flex flex-col text-white items-center lg:items-start">
              <div className="w-full md:w-[80%] lg:w-[40%] flex flex-col gap-6 md:gap-8">
                ...
                <p className="text-sm md:text-base lg:text-lg leading-6 md:leading-7 text-center lg:text-left">
                  Discover premium wellness products and a powerful referral
                  system that lets you create sustainable income, all in one
                  platform.
                </p>
                {/* Buttons */}
      ...
      <div className="w-full flex flex-col gap-24 items-center justify-center text-black py-8 md:py-16">
        <div className="w-[90%] flex flex-col gap-8 items-center text-center">
          <div className="w-full md:w-[60%] flex flex-col gap-3 items-center">
            <p className="font-bold text-2xl md:text-4xl">Why Choose Us?</p>
            <p className="w-full text-sm md:text-lg leading-7 lg:leadind-5">
              Choosing Modet means choosing better health, better income, and a
              better future, we make sure you have everything you need to
              succeed.
            </p>
          </div>
            ...
            <div className="md:hidden mt-8 space-y-8">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <div
                    className={`${feature.bgColor} h-24 flex items-center justify-center`}
                  >
        ...
        <div className="w-[90%] grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-18">
          ...
          <div className="flex flex-col gap-2 md:gap-8 justify-center">
            ...
            <p className="text-sm md:text-lg leading-7">
              We are committed to delivering only the best. products made with
              care, passion, and integrity. Every step of our process, from
              sourcing the finest ingredients to ensuring sustainable practices,
              is guided by our dedication to your well-being and satisfaction.
              When you choose us, you’re choosing quality you can trust, service
              you can rely on, and a brand that values you every step of the
              way.
            </p>
          </div>
        </div>
      ...
      <div className="w-full flex bg-pryClr items-center justify-center text-black py-8 md:py-16">
        <div className="w-[90%] flex flex-col gap-4 md:gap-6 items-center text-center text-white">
          <p className="font-bold text-2xl md:text-4xl">
            How You Can Earn Profits
          </p>
          <p className="w-full lg:w-[50%] text-sm md:text-lg leading-7 lg:leadind-5">
            Follow these three simple steps to start earning with us. It’s fast
            easy, and rewarding
          </p>
          <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6 text-black text-start mt-8">
            {steps.map((step, index) => (
              <div
                key={index}
                className="w-full bg-white p-6 flex flex-col gap-4 rounded-xl"
              >
      ...
      <div className="w-full flex bg-white items-center justify-center text-black py-8 md:py-16">
        <div className="w-[90%] flex flex-col gap-4 md:gap-6 items-center text-center text-black">
          ...
          <p className="w-full lg:w-[65%] text-sm md:text-lg leading-7 lg:leadind-5">
            Your journey to wealth generation begins here, select the package
          ...
          <div className="w-full overflow-x-auto mt-8">
            <div className="flex gap-6 min-w-max">
              {packages.map((pkg, index) => (
                <div
                  key={index}
                  className={`w-[320px] md:w-[300px] border ${pkg.borderColor} flex flex-col rounded-2xl`}
                >
                  <div
                    className={`w-full h-18 ${pkg.nameBgColor} rounded-t-2xl flex items-center justify-center ${pkg.nameTextColor} text-center`}
                  >
                    <p className="text-xl md:text-2xl font-bold exclude">
                      {pkg.name}
                    </p>
                  </div>
                  <div className="py-6 flex flex-col gap-4 items-center justify-center">
                    <p className="text-3xl md:text-4xl font-bold exclude">
                      {pkg.price}
                    ...
                    <div>
                      <Link to="/login">
                        <button
                          className={`${pkg.buttonBgColor} ${pkg.buttonTextColor} px-6 py-2 text-lg font-medium rounded-full`}
                        >
                          Get Started
                        </button>
                      </Link>
      ...
      <div className="w-full flex bg-white items-center justify-center text-black py-8 md:py-16">
        <div className="w-[90%] flex flex-col gap-4 md:gap-6 items-center text-center text-black">
          ...
          <p className="w-full lg:w-[65%] text-sm md:text-lg leading-7 lg:leadind-5">
            Find clear and straightforward answers to the most common questions
            about our products, business model, and how you can start your
            journey with us
          </p>
              ...
              >
                <div className="w-full flex items-center gap-6">
                  ...
                  <div className="flex flex-col text-start">
                    ...
                    <p className="text-base md:text-lg font-bold text-black/50 capitalize">
                      {testimonial.title}
                    </p>
                  </div>
                </div>
                <div className="w-[90%] flex items-center gap-4">
                  <div
                    className={`w-6 md:w-2 min-h-18 max-h-[calc(100%+5px)] ${index % 2 === 0 ? "bg-pryClr" : "bg-secClr"} rounded-lg`}
                  ></div>
                  <p className="w-[calc(100%-24px)] text-sm text-start md:text-base">
