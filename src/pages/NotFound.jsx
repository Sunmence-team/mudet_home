...
const NotFound = () => {
  ...
  return (
    <div className="h-[100vh] flex items-center justify-center flex-col gap-4 px-5">
      ...
      <button
        onClick={() => navigate("/")}
        className="bg-pryClr hover:bg-pryClr/80 text-white font-semibold py-2 px-12 rounded-3xl transition-all duration-300 text-xs lg:text-sm cursor-pointer text-center shadow-lg hover:shadow-xl hover:scale-105"
      >
        Go Home
      </button>
    </div>
